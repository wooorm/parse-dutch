...
const sample = `Hier kan je tekst toevoegen, verwijderen, en veranderen. Rechts verschijnt vervolgens de corresponderende syntax-boom.

Probeer ’t, het is best tof :)`
    ...
    <>
      <div className="container">
        <header className="content">
          <h1>
            <a href="https://github.com/wooorm/parse-dutch">
              <code>parse-dutch</code>
            </a>
          </h1>
        </header>
      </div>
